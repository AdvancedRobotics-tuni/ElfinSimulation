...
namespace arm_controllers{
	...
	class Cloned_Gravity: public controller_interface::Controller<hardware_interface::EffortJointInterface>
	{
		public:
		~Cloned_Gravity() 
		{
		...
		bool init(hardware_interface::EffortJointInterface* hw, ros::NodeHandle &n)
  		{	
			...
			command_sub_ = n.subscribe<std_msgs::Float64MultiArray>("command", 1, &Cloned_Gravity::commandCB, this);
...
PLUGINLIB_EXPORT_CLASS(arm_controllers::Cloned_Gravity, controller_interface::ControllerBase)
